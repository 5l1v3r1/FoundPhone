<?php
	...
	if($action) {
		...
		switch($action) {
			case "canuse":
				echo booltostr(canUse($hwid));
				break;
			case "register":
				echo booltostr(registerKey($key, $hwid));
				break;
			default:
	...
	<div id="fullWrapper">
		...
		<div id="footerWrapper">
			<div class="left" style="padding: 5px;">
				Developed and designed by: <a href="http://www.elitepvpers.com/forum/members/2342603-shawak.html">Shawak</a><br/>
				Please check <a href="?s=about">about</a> for license info.<br/>
				Page generated in _#totalTime#_ seconds.
			</div>
			<div class="right" style="padding: 10px;">
				<a href="http://www.elitepvpers.com/" target="_blank"><img class="left" src="grafik/images/epvp_re.png"></img></a>
			</div>
			<div class="clear"></div>
		</div>
	</div>
